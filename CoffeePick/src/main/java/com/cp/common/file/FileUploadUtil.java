...
public class FileUploadUtil {
   ...
   /********************************************************************************
    * 파일 업로드 메서드 파일명이 중복시 해결 방법 System.currentTimeMillis()를 사용하거나 UUID는 128비트의 수이다.
    * 표준 형식에서 UUID는 32개의 16진수로 표현되며 총 36개 문자(32개 문자와 4개의 하이픈)로 된 8-4-4-4-12라는 5개의
    * 그룹을 하이픈으로 구분한다. 이를테면 다음과 같다. 이때 UUID.randomUUID().toString()를 이용해서 얻는다.
   ...
   /**
    * 파일 삭제 메서드 이미지 경로 및 파일명: board/board_21312524646_han.jpg 참고: fileDelete(String
   ...
   public static void fileDelete(String fileName) throws IOException {
      ...
      // String docRoot = "/Users/kim-yeon-u/Desktop/coffeePickStorage/"+fileName; //
      // //Users//kim-yeon-u//Desktop//coffeePickStorage//coffeepickv

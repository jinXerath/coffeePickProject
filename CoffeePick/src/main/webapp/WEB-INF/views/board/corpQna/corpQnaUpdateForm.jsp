	...
	$(function(){
		...
		$("#qnaUpdateBtn").on("click",function(event){
			...
			$("#qnaUpdateForm").attr({
				...
				"action" : "/board/corpQna/corpQnaUpdate"
			});
		...
		$("#qnaCancelBtn").on("click",function(event){
			...
			location.href="/board/corpQna/corpQnaDetail?qna_no=${updateData.qna_no}";
		})
        ...
        <form id="qnaUpdateForm" name="qnaUpdateForm" class="col-md-9 m-auto">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control mt-1" id="store_name" name="store_name" placeholder="매장명" value="${updateData.store_name}" readonly>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3" id="beforeImg">
	            ...
	            <figure class="figure">
					<img src="/coffeePickStorage/corpQna/${updateData.qna_img}" class="figure-img img-fluid rounded">

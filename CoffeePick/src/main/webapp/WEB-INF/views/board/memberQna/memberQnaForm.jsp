...
<script type="text/javascript">
	$(function(){
		...
		$("#qnaInsertBtn").click(function(event){
			...
			if (!chkData("#qna_title", "문의 제목을")) return;
				...
				$("#qnaForm").attr({
					...
					"action" : "/board/memberQna/memberQnaInsert"
				});
				$("#qnaForm").submit();
			};
		});
		...
		$("#qnaCancelBtn").click(function(event){
			event.preventDefault();
			location.href="/board/memberQna/memberQnaList";
		})
	});
</script>
        ...
        <form id="qnaForm" name="qnaForm" class="col-md-9 m-auto">
            <div class="row">
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="email" class="form-control mt-1" id="id" name="id" placeholder="아이디" value="${member.member_id}" readonly>
                </div>
                <div class="form-group col-md-6 mb-3">
                    <label for="member_nickname">닉네임</label>
                    <input type="text" class="form-control mt-1" id="member_nickname" name="member_nickname" placeholder="Name" value="${member.member_nickname}" readonly>
                </div>
            </div>
            <div class="mb-3">

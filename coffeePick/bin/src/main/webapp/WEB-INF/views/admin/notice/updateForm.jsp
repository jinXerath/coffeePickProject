			...
			<table class="table table-bordered">
				<tbody>
					<tr>
						...
						<td class="text-left col-md-3">${updateData.board_no }</td>
						<td class="col-md-3">작성일</td>
						<td class="text-left col-md-3">${updateData.board_regdate }</td>
					</tr>
					<tr>
						<td class="col-md-3">이전 작성자</td>
						<td class="text-left col-md-3">${updateData.admin_id }</td>
						<td class="col-md-3">수정 작성자</td>
						<td class="text-left col-md-3">${adminLogin.admin_id}</td>
					</tr>
					<tr>
						<td>글제목</td>

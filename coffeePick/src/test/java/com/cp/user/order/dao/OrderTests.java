 ...
 * @Slf4j
 * 
 * @SpringBootTest public class OrderTests {
 * 
 * @Setter(onMethod_ = @Autowired) private OrderDAO orderDAO;
 * 
 * /*
 * 
 ...
 * 
 * 
 * @Test public void testGetOrderList() { OrderVO order = new OrderVO();
 * order.setPageNum(1); order.setMember_id("user1");
 * order.setKeyword("Coffee Shop"); List<OrderVO> orderList =
 * orderDAO.orderList(order);
 * 
 * for (OrderVO o : orderList) { System.out.println(o.toString()); } }
 * 
 * /*
 * 
 * @Test public void dailySales() { OrderVO ovo = new OrderVO();
 * ovo.setOrder_regdate("23-09-07"); orderDAO.dailySales(ovo);
 * log.info(ovo.toString()); }
 * 
 * 
 * @Test public void Sales() { OrderVO ovo = new OrderVO();
 * ovo.setStart_date("2023-09-01"); ovo.setEnd_date("2023-09-30");

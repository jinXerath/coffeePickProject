...
//	}
	/*
	@Test
	public void storeInfoRegist() {
		StoreVO svo = new StoreVO();
		
		svo.setCorp_id("corp1");
		svo.setStore_name("1");
		svo.setStore_content("1");
		svo.setStore_content_detail("11");
		svo.setStore_id("1");
		svo.setStore_addr("서울시 중랑구");
		svo.setStore_operate_hour("오전 11시 ~ 오후 12시");
		svo.setStore_phone("1111");
		svo.setStore_img("11");
		
		int result = storeDAO.storeInfoRegist(svo);

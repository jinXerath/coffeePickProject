...
function updateMenuQuantity(cartDetailNo, cartDetailMenuQuantity) {
    $.ajax({
        ...
        error: function() {
            MsgBox.Alert("메뉴 수량 업데이트 중 오류가 발생했습니다.");
        }
    });
}
    ...
    if (!isDuplicate) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                MsgBox.Alert("장바구니 기능은 로그인해야 이용하실수 있습니다");
            }
        });
    }
});
               ...
               <div class="row">
                  <div class="card">
                     ...
                     <div class="col-md-7 text-center mt-4">
                        <h4 class="text-primary mb-4">장바구니</h4>
                        <!-- 장바구니 목록 및 내용을 여기에 배치 -->
                     </div>
                     <!-- 장바구니 끝 -->

                     <!-- 장바구니 비우기 버튼 및 전체 선택 시작 -->
                     <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                           ...
                           <button id="deleteBtn" name="deleteBtn" type="button" class="btn btn-outline-danger">
                              <i class="fa fa-trash"></i> 선택한 메뉴 비우기
                           </button>
                        </div>
                     </div>
                     <!-- 장바구니 비우기 버튼 및 전체 선택 끝 -->

...
<body>
	<div class="container padding-bottom-3x mb-1">
		...
		<div class="alert alert-info alert-dismissible fade show text-center" style="margin-bottom: 30px;">
			<div class="small text-muted">장바구니 ID:<span id="cart_id" >${cartInfo.cart_id}</span></div>
			<p>
				<span class="alert-close" data-dismiss="alert"> 이번 구매로<i class="fa-solid fa-medal"></i> <strong class="totalPoint"></strong> 포인트를 적립하게 됩니다!
		...
		<div class="rounded border w-100 p-3 row text-center">
			<div class="col">
				<span class="h5">총 가격</span>
				<hr/>
				<div class="h5" id="totalPrice"></div>
			</div>
		</div>

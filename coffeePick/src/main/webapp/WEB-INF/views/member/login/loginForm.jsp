...
%>
    ...
    $(function(){
 	   ...
 	   $("#memberLogin").click(function() {
 		    ...
 		    $("#corpLogin").css("background-color", "#f8f9fa"); // 여기서 whine가 아닌 #f8f9fa로 수정
 		...
 		$("#corpLogin").click(function() {
 		    userLogin = 2;
 		    console.log(userLogin);
 		    $("#memberLogin").css("background-color", "#f8f9fa"); // 여기서 whine가 아닌 #f8f9fa로 수정
      ...
      /*   $("#login").click(function(){
        ...
        $("#joinPageMove").click(function () {
            if(userLogin == 2){
                console.log("코프조인폼!");
                window.location.href="/corp/corpJoinForm";    
            } else {
            ...
            <form class="login_form">
                ...
                display: table;">
                   ...
                   <!--  	<li style="background-color: #fff;"><a href="#" id="memberLogin">사용자 로그인</a></li>
                    	...
                    	<button type="button" id="memberLogin">사용자 로그인</button>
                    	<button type="button" id="corpLogin">사업자 로그인</button>                    	
                	</ul>
            	</div>
        ...
        <div class="data_find_page_move">
            <ul class="search_id_pw">
                ...
                <li id="joinPageMove"><a href="#" id="joinPageMove">회원가입</a></li>
            </ul>
        </div>

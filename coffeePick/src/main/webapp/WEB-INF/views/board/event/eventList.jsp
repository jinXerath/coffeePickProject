...
<script>
   $(function() {
      ...
      $('#insertFormBtn').click(function() {
         location.href = '/board/qna/memberQnaForm';
      });
      ...
      $(".goDetail").click(function() {
         ...
         $("#detailForm").attr({
            "method" : "get",
            "action" : "/board/qna/memberQnaDetail"
         });
         $("#detailForm").submit();
      });
   ...
   function goPage() {
      ...
      $("#memberQnaSearchForm").attr({
         "method" : "get",
         "action" : "/board/qna/memberQnaList"
      });
...
<section class="py-5 container">
   ...
   <div id="memberQnaSearch" class="mb-2">
                 ...
                 <c:when test="${not empty memberQnaList}">
                    <c:forEach var="memberQna" items="${memberQnaList}" varStatus="status">
                     <tr data-num="${memberQna.qna_no}">
                        ...
                        <td style="color: ${memberQna.qna_secret == 'Y' ? 'green' : 'red'}">
                           ${memberQna.qna_secret =='Y' ? '답변완료' : '답변대기'}
                        </td>
                        <td class="goDetail">${memberQna.qna_title}</td>
                        <td>
                           ${memberQna.member_nickname} (${fn:substring(memberQna.id, 0, 3)}${'*****'})
                        </td>

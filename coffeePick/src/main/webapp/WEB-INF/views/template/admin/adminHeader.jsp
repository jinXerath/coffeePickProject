...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="/admin">Coffee Pick Administrator</a>
    <!-- Sidebar Toggle-->
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            	<c:if test="${adminLogin.admin_authority == 'S'}">
            		<li><a class="dropdown-item" href="/admin/supervisor">supervisor</a></li>
            	</c:if>
                <li><a class="dropdown-item" href="/admin/update">modify</a></li>
                <li><hr class="dropdown-divider"/></li>
                <li><a class="dropdown-item" href="/admin/sign/logout">Logout</a></li>
            </ul>
        </li>
    </ul>
</nav>
...
public class CorpController {
	...
	public String memberJoin(@ModelAttribute CorpVO vo, Model model) {// @ModelAttribute는 멤버VO객체를 만듬과 동시에 그 객체에 전송한 값을
																		// 할당
		log.info("실행됨");
	...
	public ResponseEntity<Integer> phoneNumberMsg(@RequestParam("corp_phone") String corp_phone) {
		...
		log.info(toString().valueOf(messageService));
	...
	// 회원 비밀번호 변경
	@PostMapping("pwAlter")
	public ResponseEntity<Integer> pwAlter(@RequestParam("corp_id") String corp_id,
			@RequestParam("corp_pw") String corp_pw) {
	...
	public ResponseEntity<Integer> corp_pw_check(@RequestParam("corp_id") String corp_id,
			@RequestParam("corp_pw") String corp_pw) {
		log.info("코프컨트롤러시작");
		log.info(corp_pw);
		log.info(corp_id);
	...
	public ResponseEntity<Integer> corp_delete(@RequestParam("corp_id") String corp_id,
			@RequestParam("corp_pw") String corp_pw) {
		log.info("삭제컨트롤러시작");
		log.info(corp_pw);
		log.info(corp_id);
	...
	public ResponseEntity<Integer> corp_data_update(@RequestParam("corp_id") String corp_id,
			@RequestParam("corp_name") String corp_name, @RequestParam("corp_email") String corp_email,
			@RequestParam("corp_addr") String corp_addr, @RequestParam("corp_phone") String corp_phone,
		...
		int result = service.corp_data_update(corp_id, corp_name, corp_email, corp_addr, corp_phone,
